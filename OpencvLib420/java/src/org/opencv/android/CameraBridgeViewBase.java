    ...
    protected void deliverAndDrawFrame(CvCameraViewFrame frame) {
        ...
        if (bmpValid && mCacheBitmap != null) {
            ...
            if(canvas.getHeight()>canvas.getWidth()){
                ...
                // First rotate
                // Second scale to fi android surface
                // mCacheBitmap.getWidth() will be or frame height
                //
                canvas.rotate(90f,canvas.getWidth()/2,canvas.getHeight()/2);

                mScale1=canvas.getHeight()/mCacheBitmap.getWidth();
                mScale2=canvas.getWidth()/mCacheBitmap.getHeight();

            }
            else{
                // For landscape mode will be different because we not rotate camera frame by 90 degrees
                // We just need to scale it to fit
                mScale1=canvas.getWidth()/mCacheBitmap.getWidth();
                mScale2=canvas.getHeight()/mCacheBitmap.getHeight();
            }
            ...
            if (canvas != null) {
                ...
                // we modify this if conditional structure with our scale variables
                // this code will scale canvas to fit our phone
                if (mScale1 != 0) {
